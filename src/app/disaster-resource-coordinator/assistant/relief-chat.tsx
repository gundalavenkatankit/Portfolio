...
type AssistantData = { answer: string; context: ConversationContext; sources: { name: string; url: string }[]; results: { title: string; details: string[]; url?: string | null }[] };
  ...
  return <>
    ...
    <main id="assistantMain" className="assistantPage">
      ...
      <div className="assistantLayout">
        ...
        <aside className="assistantSources" aria-label="Official data sources"><p className="reliefEyebrow">Source coverage</p><h2>What I can check</h2><ul><li><a href="https://www.weather.gov/alerts" target="_blank" rel="noreferrer"><strong>Weather alerts</strong><span>National Weather Service</span></a></li><li><a href="https://www.fema.gov/disaster/declarations" target="_blank" rel="noreferrer"><strong>Disaster declarations</strong><span>OpenFEMA</span></a></li><li><a href="https://www.disasterassistance.gov/information/immediate-needs/emergency-shelter" target="_blank" rel="noreferrer"><strong>Shelter records</strong><span>FEMA ESF 6</span></a></li><li><a href="https://egateway.fema.gov/ESF6/DRCLocator" target="_blank" rel="noreferrer"><strong>Recovery centers</strong><span>FEMA</span></a></li></ul><p>This assistant uses controlled rules rather than a generative model. It cannot guarantee availability, eligibility, or safety.</p></aside>
      </div>
    </main>
  </>;
}
